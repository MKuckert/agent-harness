 ...
 * **Library Suggestions:** If a requirement lacks an appropriate library, provide 2–3 well-reasoned alternatives (including pros and cons) and await the user's decision. *Note: Frameworks already existing within the project take precedence.*
